...
var TabsPage = (function () {
    ...
    TabsPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"/home/mint/Development/Sources/secretcards/mobile/ionic-latest/cards/src/pages/tabs/tabs.html"*/'<ion-tabs>\n  <ion-tab [root]="tab0Root" tabTitle="Login" tabIcon="person"></ion-tab>\n  <ion-tab [root]="tab1Root" tabTitle="Home" tabIcon="home"></ion-tab>\n  <ion-tab [root]="tab2Root" tabTitle="New" tabIcon="document"></ion-tab>\n  <ion-tab [root]="tab3Root" tabTitle="Tags" tabIcon="pricetags"></ion-tab>\n</ion-tabs>\n'/*ion-inline-end:"/home/mint/Development/Sources/secretcards/mobile/ionic-latest/cards/src/pages/tabs/tabs.html"*/
        }),
...
var AboutPage = (function () {
    ...
    AboutPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-about',template:/*ion-inline-start:"/home/mint/Development/Sources/secretcards/mobile/ionic-latest/cards/src/pages/about/about.html"*/'<ion-header>\n    <ion-navbar>\n      <ion-title>New Card</ion-title>\n    </ion-navbar>\n  </ion-header>\n  \n  <ion-content padding>\n    <h2>Welcome to Ionic!</h2>\n    <p>\n      This starter project comes with simple tabs-based layout for apps\n      that are going to primarily use a Tabbed UI.\n    </p>\n    <p>\n      Take a look at the <code>src/pages/</code> directory to add or change tabs,\n      update any existing page or create new pages.\n    </p>\n  </ion-content>\n'/*ion-inline-end:"/home/mint/Development/Sources/secretcards/mobile/ionic-latest/cards/src/pages/about/about.html"*/
        }),
        __metadata("design:paramtypes", [])
    ], AboutPage);
    return AboutPage;
...
var ContactPage = (function () {
    ...
    ContactPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-contact',template:/*ion-inline-start:"/home/mint/Development/Sources/secretcards/mobile/ionic-latest/cards/src/pages/contact/contact.html"*/'<ion-header>\n  <ion-navbar>\n    <ion-title>\n      Contact\n    </ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content>\n  <ion-list>\n    <ion-list-header>Follow us on Twitter</ion-list-header>\n    <ion-item>\n      <ion-icon name="ionic" item-start></ion-icon>\n      @ionicframework\n    </ion-item>\n  </ion-list>\n</ion-content>\n'/*ion-inline-end:"/home/mint/Development/Sources/secretcards/mobile/ionic-latest/cards/src/pages/contact/contact.html"*/
        }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__app_jwt_jwt_service__ = __webpack_require__(277);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__angular_http__ = __webpack_require__(99);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__pages_select_select__ = __webpack_require__(200);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_rxjs_add_operator_map__ = __webpack_require__(278);
...
var HomePage = (function () {
    ...
    HomePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-home',template:/*ion-inline-start:"/home/mint/Development/Sources/secretcards/mobile/ionic-latest/cards/src/pages/home/home.html"*/'<ion-header>\n    <ion-navbar>\n      <ion-title>\n        Home\n      </ion-title>\n    </ion-navbar>\n  </ion-header>\n  \n  <ion-content padding>\n        <ion-list>\n            <ion-item *ngFor="let card of cards" (click)="select(card)">\n                <ion-item-group reorder="true">  \n                  <ion-icon name="document" large ></ion-icon>\n                            {{card.title}}\n                  <ion-item *ngFor="let tag of card.tags">\n                      <ion-icon name="ios-pricetags-outline">            {{tag.name}}</ion-icon>\n                    </ion-item>\n                </ion-item-group>\n            </ion-item>\n        </ion-list>\n </ion-content>\n'/*ion-inline-end:"/home/mint/Development/Sources/secretcards/mobile/ionic-latest/cards/src/pages/home/home.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* NavController */],
...
var SelectPage = (function () {
    ...
    SelectPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"/home/mint/Development/Sources/secretcards/mobile/ionic-latest/cards/src/pages/select/select.html"*/'<ion-header>\n        <ion-navbar>\n          <ion-title>\n             Card\n          </ion-title>\n        </ion-navbar>\n      </ion-header>\n\n<ion-content padding>\n    <ion-card>\n        <ion-card-content>\n            <ion-item-group>\n                <ion-item-divider color="light">\n                    <ion-icon name="document" item-left></ion-icon>\n                    {{ card.title }}\n                </ion-item-divider>\n                \n                <ion-item *ngFor="let tag of card.tags">\n                    <ion-icon name="ios-pricetags-outline">     {{tag.name}}</ion-icon>\n                </ion-item>\n\n                <ion-input type="text" value="{{card.description}}"></ion-input>   \n        \n            </ion-item-group>\n        </ion-card-content>\n    </ion-card>\n    <button ion-button block (click)="save()">Save</button>\n    <button ion-button block (click)="cancel()">Cancel</button>\n</ion-content>'/*ion-inline-end:"/home/mint/Development/Sources/secretcards/mobile/ionic-latest/cards/src/pages/select/select.html"*/
        }),
...
var LoginPage = (function () {
    ...
    LoginPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'login',template:/*ion-inline-start:"/home/mint/Development/Sources/secretcards/mobile/ionic-latest/cards/src/pages/login/login.html"*/'<ion-header>\n    <ion-navbar>\n        <ion-title>\n            Login\n        </ion-title>\n    </ion-navbar>\n</ion-header>\n      \n<ion-content>\n    <ion-list>\n\n        <ion-item>\n            <ion-label stacked>Username</ion-label>\n            <ion-input type="text"></ion-input>\n        </ion-item>\n        \n        <ion-item>\n            <ion-label stacked>Password</ion-label>\n            <ion-input type="password"></ion-input>\n        </ion-item>\n        \n        <ion-item padding>\n            <button ion-button block (click)="login()">Login</button>\n        </ion-item>\n    </ion-list>\n\n</ion-content>'/*ion-inline-end:"/home/mint/Development/Sources/secretcards/mobile/ionic-latest/cards/src/pages/login/login.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* NavController */]])
    ], LoginPage);
    return LoginPage;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__pages_select_select__ = __webpack_require__(200);
...
var MyApp = (function () {
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"/home/mint/Development/Sources/secretcards/mobile/ionic-latest/cards/src/app/app.html"*/'<ion-nav [root]="rootPage"></ion-nav>\n'/*ion-inline-end:"/home/mint/Development/Sources/secretcards/mobile/ionic-latest/cards/src/app/app.html"*/
        }),
